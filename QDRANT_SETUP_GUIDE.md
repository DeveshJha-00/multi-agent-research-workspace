> **Archived setup notes:** Qdrant is now the active backend; no source-code switching is required.
> Follow the current local and Qdrant Cloud instructions in [README.md](README.md).

# Qdrant Setup Guide - Legacy Switching Instructions
