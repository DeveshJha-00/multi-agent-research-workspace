> **Archived design:** this document describes the removed FAISS implementation. The current,
> deployable Qdrant flow is documented in [README.md](README.md).

# Document Upload Flow - Legacy FAISS Design
